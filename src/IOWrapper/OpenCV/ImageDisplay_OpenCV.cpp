...
void displayImageStitch(const char* windowName,
        ...
        for (size_t i = 0; i < images.size(); i++)
                imagesCV.push_back(new cv::Mat(images[i]->h, images[i]->w,
                                               CV_8U, images[i]->data));
