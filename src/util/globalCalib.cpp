...
void
setGlobalCalib(int w, int h, const Eigen::Matrix3f& K)
{
        int wlvl = w;
        int hlvl = h;
        pyrLevelsUsed = 1;
        ...
        if (wlvl > 100 && hlvl > 100) {
                printf("\n\n===============WARNING!===================\n "
                       ...
                       "Consider scaling to a resolution that is a multiple of "
                       "a power of 2.\n");
        }
        if (pyrLevelsUsed < 3) {
                printf("\n\n===============WARNING!===================\n "
        ...
        for (int level = 1; level < pyrLevelsUsed; ++level) {
                ...
                KG[level] << fxG[level], 0.0, cxG[level], 0.0, fyG[level],
                  cyG[level], 0.0, 0.0, 1.0; // synthetic
