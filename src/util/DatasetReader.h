  ...
  private:
    MinimalImageB* getImageRaw_internal(int id, int unused)
    {
        if (!isZipped) {
            ...
            long readbytes = zip_fread(
              fle, databuffer, (long)widthOrg * heightOrg * 6 + 10000);
            ...
            if (readbytes > (long)widthOrg * heightOrg * 6) {
                ...
                readbytes = zip_fread(
                  fle, databuffer, (long)widthOrg * heightOrg * 30 + 10000);
