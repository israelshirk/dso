...
float setting_kfGlobalWeight = 1;  // general weight on threshold, the larger
				   // the more KF's are taken (e.g., 2 = double
				   // the amount of KF's).
...
int setting_gammaWeightsPixelSelect = 1;  // 1 = use original intensity for
					  // pixel selection; 0 = use
