                       ...
                       bool debugPrint)
{
    ...
    //iterations 	const float GNThreshold = 0.1;
    //// GN stop after this stepsize. 	const float extraSlackOnTH = 1.2;
    //// for energy-based outlier check, be slightly more relaxed by this
    //factor.
    //	const float slackInterval = 0.8;			// if pixel-interval is smaller
    //than this, leave it be.
    //	const float minImprovementFactor = 2;		// if pixel-interval is smaller
    //than this, leave it be.
    ...
    for (int i = 0; i < numSteps; i++) {
        ...
        for (int idx = 0; idx < patternNum; idx++) {
            float hitColor =
              getInterpolatedElement31(frame->dI,
    ...
    for (int it = 0; it < setting_trace_GNIterations; it++) {
        ...
        for (int idx = 0; idx < patternNum; idx++) {
            Vec3f hitColor =
              getInterpolatedElement33(frame->dI,
