                              ...
                              std::vector<IOWrap::Output3DWrapper*>& wraps)
{
    ...
    for (int lvl = pyrLevelsUsed - 1; lvl >= 0; lvl--) {
        ...
        Vec8f b, bsc;
        resetPoints(lvl);
        Vec3f resOld = calcResAndGS(
          lvl, H, b, Hsc, bsc, refToNew_current, refToNew_aff_current, false);
        applyStep(lvl);
                             ...
                             std::vector<IOWrap::Output3DWrapper*>& wraps)
{
    ...
    for (int i = 0; i < npts; i++) {
        ...
        if (!point->isGood)
            ...
            iRImg.setPixel9(
              point->u + 0.5f, point->v + 0.5f, makeRainbow3B(point->iR * fac));
    }
        ...
        for (int i = 0; i < npts; i++) {
            ...
            if (lvl < pyrLevelsUsed - 1) {
                ...
                indexes[lvl + 1]->findNeighbors(
                  resultSet1, (float*)&pt, nanoflann::SearchParams());
